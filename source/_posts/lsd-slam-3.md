...
$$\begin{equation} {\mathbf{x}^\prime} = \left[ {\begin{array}{*{20}{c}} \mathbf{R}_{3 \times 3} & \mathbf{t}_{3 \times 1 }\\ \mathbf{0}^T_{1 \times 3} & 1_{1 \times 1} \end{array}} \right]{\mathbf{x}} \end{equation}$$
